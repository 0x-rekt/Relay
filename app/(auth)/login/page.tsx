...
export default function LoginPage() {
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-zinc-950 text-zinc-50 relative overflow-hidden">
      ...
      <div className="z-10 w-full max-w-md px-6">
        ...
        <Card className="bg-zinc-900/50 border-zinc-800 backdrop-blur-xl shadow-2xl">
          ...
          <CardContent className="space-y-4">
            <Button
              variant="outline"
              className="w-full h-11 bg-zinc-950 border-zinc-800 hover:bg-zinc-800 hover:border-zinc-700 hover:text-zinc-100 text-zinc-300 transition-all font-medium cursor-pointer"
            >
          ...
          <CardFooter className="flex flex-wrap justify-center text-center text-sm text-zinc-500 pt-4">
            <p>
